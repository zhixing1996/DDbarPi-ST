...
DIR_NAME="/besfs5/groups/cal/dedx/$USER/bes/DDbarPi-ST/run/DDbarPi/rtraw/mc/DDPI/$ENERGYPOINT/"
mkdir -p $DIR_NAME
...
do
    ...
    echo "EvtDecay.userDecayTableName = \"/besfs5/groups/cal/dedx/$USER/bes/DDbarPi-ST/run/DDbarPi/gen_script/gen_mc/decay/psi4260_D_D_PI_PHSP.dec\";" >> $SIM_NAME
    echo "EvtDecay.PdtTableDir = \"/besfs5/groups/cal/dedx/$USER/bes/DDbarPi-ST/run/DDbarPi/gen_script/gen_mc/decay/pdt_${BOSS}.table\";" >> $SIM_NAME
